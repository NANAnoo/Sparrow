...
<<<<<<< HEAD
std::shared_ptr<SPW::Entity>
createDlight(const std::shared_ptr<SPW::Scene> &scene, glm::vec3 rotation, glm::vec3 color) {
    auto light = scene->createEntity("light");
    auto lightTrans = light->emplace<SPW::TransformComponent>();
...
<<<<<<< HEAD
            ...
            auto p_shadowmap_node = pbr_with_PDshadow->createRenderNode<SPW::ModelRepeatPassNode>(SPW::CubeMapType,
                                                                                                  SPW::RepeatForPLights,
                                                                                                  10);
            ...
            auto d_shadowmap_node = pbr_with_PDshadow->createRenderNode<SPW::ModelRepeatPassNode>(SPW::ColorType,
                                                                                                  SPW::RepeatForDLights,
                                                                                                  10);
            ...
            auto pbr_light_shadow_desc = PBR_light_with_shadow_desc(p_shadowmap_output, d_shadowmap_output,
                                                                    pbr_light_shadow);
            auto pbr_light_shadow_tiled_desc = PBR_light_with_shadow_desc(p_shadowmap_output, d_shadowmap_output,
                                                                          pbr_light_shadow_tiled);
...
<<<<<<< HEAD
            ...
            auto test_button = new SPW::UIButton(scene->getUIResponder(), scene, "test");
            test_button->setButtonOnClick([](){
                std::cout << "Button 1 Clicked" << std::endl;
            });
            test_button->setButtonOnHover([](){
                std::cout << "Button 1 Hovered" << std::endl;
            });
            test_button->setButtonNoHover([](){
                std::cout << "Button 1 No Hover" << std::endl;
            });
            test_button->setPosition(50,50);
            test_button->setSize(100,200);
...
>>>>>>> main
            ...
            auto test_button3 = new SPW::UIButton(scene->getUIResponder(), scene, "test3");
            test_button3->setButtonOnClick([](){
                std::cout << "Button 3 Clicked" << std::endl;
            });
            test_button3->setButtonOnHover([](){
                std::cout << "Button 3 Hovered" << std::endl;
            });
            test_button3->setButtonNoHover([](){
                std::cout << "Button 3 No Hover" << std::endl;
            });
            test_button3->setPosition(50,50);
            test_button3->setSize(150,150);
